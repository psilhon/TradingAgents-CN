...
def test_api_key_validation():
    ...
    test_cases = [
        ...
        ("REDACTED_DEEPSEEK_KEY_EXAMPLE_A", True, "有效的 API Key"),
        ("REDACTED_DEEPSEEK_KEY_EXAMPLE_B", True, "有效的 API Key"),
        ("REDACTED_GOOGLE_KEY_EXAMPLE", True, "有效的 Google API Key"),
        ("REDACTED_QIANFAN_KEY_EXAMPLE", True, "有效的千帆 API Key"),
        ("REDACTED_OPENROUTER_KEY_EXAMPLE", True, "有效的 OpenRouter API Key"),
