...
# 导入Google工具调用处理器
from tradingagents.agents.utils.company_resolver import get_company_name  # noqa: E402
...
def create_fundamentals_analyst(llm, toolkit):
    ...
    def fundamentals_analyst_node(state):
        ...
        is_qwen_like = (
            "DashScope" in llm_class_name or "qwen" in str(model_name).lower() or "dashscope" in str(original_base_url or "").lower()
        )
        ...
        if GoogleToolCallHandler.is_google_model(fresh_llm):
            ...
            if current_tool_calls > 0:
                ...
                if has_tool_result:
                    ...
                    return {"fundamentals_report": report, "messages": [force_result], "fundamentals_tool_call_count": tool_call_count}
                    ...
                    return {"messages": [result], "fundamentals_report": fallback_report, "fundamentals_tool_call_count": tool_call_count}
                else:
                    # 第一次调用工具，正常流程
                ...
                if has_tool_result or has_analysis_content:
                    ...
                    return {"fundamentals_report": report, "messages": [result], "fundamentals_tool_call_count": tool_call_count}
